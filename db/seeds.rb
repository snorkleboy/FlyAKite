...
event6 = Event.create!(
  ...
  startDate: DateTime.new(2018, 1, 28, 2, 30),
  endDate: DateTime.new(2018, 2, 28, 8, 30),
  header: 'A class on kite aerodynamics',
  description: "A rare public lecure from Dr. Professor Dumbledum on the advanced quantum aerodynamics of post aligned kites. Professor Dumbledum has long been regarded as the foremost expert on kites and astrophysics, his new lecture tour focus' on kites interaction with the medium through which it moves and exlains the startling revelation that as far as the most precise equipment can measure, kites do not experience time or space dilation even at speeds approaching that of 10m/s",
  areaCode: 94_110,
  city: 'San Fransisco',
  state: 'CA',
...
event7 = Event.create!(
  ...
  description: 'Another way that our brothers in arms give back to the community, Elite afghani green berets will demonstrate various kite flying techniques and how they can be used for reconnaissance and crowd control. ',
  areaCode: 94_618,
  city: 'Piedmont',
  state: 'CA',
